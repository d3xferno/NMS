            ...
            <>
                <nav className="z-40 text-[20px] font-semibold flex gap-5 justify-between items-center h-[100px] border-b-2 sticky top-0">
                    ...
                    <div className="flex gap-5 mr-10 justify-center items-center">
                        <Link to="/" className="p-1 border-b-2 rounded-sm hover:border-b-black">Home</Link>
                        <Link to="/request" className="p-1 border-b-2 rounded-sm hover:border-b-black">Requests</Link>
                        <Link to="/upload" className="p-1 border-b-2 rounded-sm hover:border-b-black">Upload</Link>
                        <Link to="/search" className=" p-1 border-b-2 rounded-sm hover:border-b-black">Search</Link>
                        <div className="relative inline-block">
                            ...
                            </svg>
                            {
                                ...
                                <div className="z-1 absolute top-20 right-10 text-[18px] shadow-md p-5 w-[200px] text-center space-y-4 rounded-md bg-white flex flex-col justify-center items-center">
                                    ...
                                    className="border-2 p-2 hover:bg-gray-200 rounded-md">Sign Out</button>
                                </div>
                            }
                        </div>
